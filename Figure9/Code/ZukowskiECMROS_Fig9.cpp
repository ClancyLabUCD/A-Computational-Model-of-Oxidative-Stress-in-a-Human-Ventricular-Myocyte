...
// Figure 9: nested sweep over pacing cycle length (CL) and DOX severity
// (D)
//
// 3 pacing conditions (CL = 500, 750, 1000 ms) x 8 DOX severity levels
// (D = 0, 0.5, 0.6, 0.7, 0.75, 0.8, 0.9, 1.0) = 24 total runs.
...
double D = 0.0;               // DOX severity (set per run in main)
...
//------------------------------------------------------------------
// Pacing conditions and DOX severity conditions to sweep.
//------------------------------------------------------------------
