...
// 1Hz, Figure 6
// Looped over 2 fixed ROSi conditions (base, high) -> separate output
...
const double ft=10*CL;//final time
...
//------------------------------------------------------------------
// 2 fixed ROSi conditions to sweep. Output files are named
// output3_HZ_1Hz_base.txt, output3_HZ_1Hz_high.txt
//------------------------------------------------------------------
...
const ROSiCondition conditions[numConditions] = {
    {1E-6,  "output3_HZ_1Hz_base.txt"},
    {1.5E-3, "output3_HZ_1Hz_high.txt"}
};
